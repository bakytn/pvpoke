		...
		function interfaceObject(){
			...
			this.displayRankingEntry = function(r, index){
				...
				switch(sort){
					...
					var canonicalSpeciesId = pokemon.aliasId ? pokemon.aliasId : pokemon.speciesId;
					var canonicalNoShadow = canonicalSpeciesId.replace("_shadow", "");

					if(limitedPokemon.indexOf(canonicalNoShadow) > -1){
				...
				if(battle.getCup().slots){
					let slotNumbers = [];
						...
						for(var n = 0; n < battle.getCup().slots.length; n++){
							...
							if((slot.pokemon.indexOf(pokemon.speciesId) > -1)
								|| (slot.pokemon.indexOf(pokemon.speciesId.replace("_shadow","")) > -1)
								|| (slot.pokemon.indexOf(canonicalSpeciesId) > -1)
								|| (slot.pokemon.indexOf(canonicalNoShadow) > -1)){
